...
public class GeofenceActivity extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        currentDBcordinates.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.d(TAG, "onMarkerClickListener: " + location );
            }
    ...
    private void markerLocation(LatLng latLng) {
        ...
        MarkerOptions markerOptions = new MarkerOptions()
                .position(latLng)
                .title(title).icon(BitmapDescriptorFactory.fromResource(R.drawable.markercuser));
        if ( map!=null ) {
    ...
    private void markerForGeofence(LatLng latLng) {
        ...
        MarkerOptions markerOptions = new MarkerOptions()
                .position(latLng)
                .title("Bag").icon(BitmapDescriptorFactory.fromResource(R.drawable.marker));
    ...
    private void clearGeofence() {
        ...
        LocationServices.GeofencingApi.removeGeofences(
            ...
            public void onReceiveResult(@NonNull Status result) throws RemoteException {
